...
# 🚨 [자물쇠 고정 핵심 1] 앱이 처음 켜질 때만 초기값 26을 세팅하고, 이후 리런 시에는 절대 26으로 덮어쓰지 않음
...
# 🚨 [자물쇠 고정 핵심 2] 상단 스타일 렌더링 시 무조건 세션에 살아남은 글자 크기를 강제 적용
...
# 🚨 [자물쇠 고정 핵심 3] slider의 value를 주머니에서 직접 꺼내고, key를 똑같이 지정하여 실시간 양방향 자물쇠를 채웁니다.
font_size = st.slider(
